...
return array(
    'layout' => array(
        ...
        'layouts_settings'                       => array(
            'name' => __( 'Layouts', 'yith-woocommerce-cart-messages' ),
            'desc' => __( 'In this section you can customize each message layout' ),
            'type' => 'title',
            'id'   => 'ywcm_section_layout'
        ),


        'layouts_settings_end'                   => array(
            'type' => 'sectionend',
            'id'   => 'ywcm_section_layout_end'
        ),
