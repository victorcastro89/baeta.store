        ...
        if ( isset( $sguide_post_id[0] ) && !empty( $sguide_post_id[0] ) ){
            ...
            if ( $terms ) {
                foreach( $terms as $term ){
                    if ( get_term_meta( $term->term_id, 'woodmart_chosen_sguide' ) ) {
                        $sguide_post_id = get_term_meta( $term->term_id, 'woodmart_chosen_sguide' );
                    }else{
        ...
        if ( isset( $_POST['woodmart_sguide_category'] ) ) {
            ...
            foreach( $terms as $term ){
                if ( !in_array( $term->term_id, $selected_sguide_category ) ) {
                    if ( $post_id == get_term_meta( $term->term_id, 'woodmart_chosen_sguide' ) ) {
