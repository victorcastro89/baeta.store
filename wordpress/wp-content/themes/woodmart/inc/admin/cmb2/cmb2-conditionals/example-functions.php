...
function yourprefix_register_conditionals_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'    => __( 'Test Multi Checkbox', 'woodmart' ),
		'desc'    => __( 'field description (optional)', 'woodmart' ),
		'id'      => $prefix . 'multi-checkbox',
		'type'    => 'multicheck',
		'options' => array(
			'check1' => __( 'Check One', 'woodmart' ),
			'check2' => __( 'Check Two', 'woodmart' ),
			'check3' => __( 'Check Three', 'woodmart' ),
		),
	) );
