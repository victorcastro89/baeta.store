...
<div id="intro" class="ccfw-tab-pane active">
	...
	<div class="ccfw-tab-pane-center">
		...
		<p><?php esc_html_e( 'We provide lots of theme documentation articles including a detailed installation and setup guide on our website.', 'shoptimizer' ); ?></p>
		<p><a target="_blank" href="<?php echo esc_url( 'https://www.commercegurus.com/docs/shoptimizer/' ); ?>" class="button button-primary"><?php esc_html_e( 'View Theme Documentation', 'shoptimizer' ); ?></a></p>
	...
	<img src="<?php echo get_template_directory_uri() . '/inc/setup/images/screenshot.jpg'; ?>" alt="Screenshot" />
		...
		<a target="_blank" class="button-primary" href="<?php echo esc_url( 'https://commercegurus.com/shoptimizer/' ); ?>"><?php esc_html_e( 'Shoptimizer Information', 'shoptimizer' ); ?></a>
		</div>
	</div>

	<div class="ccfw-review">
		<h2><?php esc_html_e( 'Support', 'shoptimizer' ); ?></h2>
		<p><?php esc_html_e( 'Have any questions or need help? Get in touch with our support desk for assistance. You will need to include your purchase code, a link to your site and a screenshot of the issue.', 'shoptimizer' ); ?></p>
